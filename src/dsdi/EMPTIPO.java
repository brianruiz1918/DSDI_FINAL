...
public class EMPTIPO extends javax.swing.JFrame {
    ...
    public EMPTIPO() {
        ...
        c4.addItem("- - - - - - - - - - - - - - - ");  
        c4.addItem("MATRICULA EMPLEADO");
        c4.addItem("MATRICULA TIPOTELF");
        c4.addItem("NUM TELEFONO");    
        c4.addItem("1.------------------------------------------------------------");
    ...
    private void initComponents() {
        ...
        jPanel1.add(t3);
        t3.setBounds(720, 160, 280, 40);

        jLabel4.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        jLabel4.setText("TELEFONO1");
        jPanel1.add(jLabel4);
        jLabel4.setBounds(720, 130, 240, 30);
        ...
        jButton17.setBounds(630, 160, 40, 40);
        ...
        jButton16.setBounds(580, 160, 40, 40);
        ...
        jButton14.setBounds(300, 160, 40, 40);
        ...
        jButton15.setBounds(250, 160, 40, 40);
        ...
        jLabel3.setText("ID TIPOTELF1 ");
        jPanel1.add(jLabel3);
        jLabel3.setBounds(400, 130, 240, 30);

        jLabel2.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        jLabel2.setText("ID EMPLEADO1");
        jPanel1.add(jLabel2);
        jLabel2.setBounds(80, 130, 210, 30);
        jPanel1.add(t2);
        t2.setBounds(400, 160, 170, 40);
        jPanel1.add(t1);
        t1.setBounds(80, 160, 160, 40);
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/FOTOS/EMPTIPOF.png"))); // NOI18N
        jPanel1.add(jLabel1);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        bandera=1;
         try{
            ...
            ResultSet rs=stmt.executeQuery("EXEC CONSEMPTIPO");
            
            tabla.addColumn("ID EMPLEADO 1");
            tabla.addColumn("ID TIPOTELF 1");
    ...
    try{
            if (
                ...
                con= DriverManager.getConnection("jdbc:sqlserver://localhost:1433;databaseName=BASEYAIR; user=sa; password=sasa;");
                Statement stmt=con.createStatement();
                ResultSet rs=stmt.executeQuery("EXEC ELIMEMPTIPO '"+var2+"','"+var1+"'");
    ...
    try{
            if (
                ...
                con= DriverManager.getConnection("jdbc:sqlserver://localhost:1433;databaseName=BASEYAIR; user=sa; password=sasa;");
                Statement stmt=con.createStatement();
                ResultSet rs=stmt.executeQuery("EXEC INGEMPTIPO '"+ var1 + "','"+ var2 + "','" +var3+"'");
    ...
    try{
        ...
        op=c4.getSelectedItem().toString();
            ...
            if (op.equals("MATRICULA EMPLEADO")) {
            DefaultTableModel tabla=new DefaultTableModel();
            Connection con;
            con= DriverManager.getConnection("jdbc:sqlserver://localhost:1433;databaseName=BASEYAIR; user=sa; password=sasa;");
            Statement stmt=con.createStatement();
            ResultSet rs=stmt.executeQuery("exec BSEMPTIPO '"+jTextField1.getText()+"'");
                tabla.addColumn("ID EMPLEADO 1");
                tabla.addColumn("ID TIPOTELF 1");
                tabla.addColumn("TELEFONO 1");
            ...
            ResultSet rs=stmt.executeQuery("exec BSEMPTIPO2 '"+jTextField1.getText()+"'");
                tabla.addColumn("ID EMPLEADO 1");
                tabla.addColumn("ID TIPOTELF 1");
                tabla.addColumn("TELEFONO 1");
            ...
            ResultSet rs=stmt.executeQuery("exec BSEMPTIPO3 '"+jTextField1.getText()+"'");
                tabla.addColumn("ID EMPLEADO 1");
                tabla.addColumn("ID TIPOTELF 1");
                tabla.addColumn("TELEFONO 1");
    ...
    private void jButton16ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton16ActionPerformed
        ...
        bandera=3;
         try{
            ...
            tabla.addColumn("ID TIPO TELF");
            tabla.addColumn("NOMBRE TIPO TELF");
    ...
    try{
            if (
                ...
                con= DriverManager.getConnection("jdbc:sqlserver://localhost:1433;databaseName=BASEYAIR; user=sa; password=sasa;");
                Statement stmt=con.createStatement();
                ResultSet rs=stmt.executeQuery("EXEC ACTEMPTIPO '"+ var1 + "','"+ var2 + "','"+ var3+"'" );
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(EMPTIPO.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
