...
public class ALCALDIA extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel3.setText("NOMBRE DE ALCALDIA");
        jPanel1.add(jLabel3);
        jLabel3.setBounds(500, 130, 190, 30);

        jLabel2.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        jLabel2.setText("CLAVE DE ALCALDIA");
        jPanel1.add(jLabel2);
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/FOTOS/ALCALDIAF.png"))); // NOI18N
        jPanel1.add(jLabel1);
        ...
        jMenu3.setText("Consultas Complejas");

        jMenuItem17.setText("NOM FARM - DIR - CEDULA - CORREO - HORARIO");
        ...
        jMenuItem18.setText("NOM EMP - DIR - PUESTO - HORARIO");
        ...
        jMenuItem19.setText("NOM FARM - DIR - TIPOTELF - NUM TELF");
        ...
        jMenuItem20.setText("NOM EMP - TIPOTELF - NUM TEL");
        ...
        jMenuItem21.setText("NOM FARMACEUTICO - NOM FARM - DIR");
        ...
        jMenuItem22.setText("NOM MEDICAMENTO - NOM MONODROGA");
        ...
        jMenuItem23.setText("NOM MEDICAMENTO - NOM LABOR - NOM ACCION TERAP");
        ...
        jMenuItem24.setText("NOM MED - PRESENT - UNID MEDIDA - FARM - FOLO - PRECIO - STOCK ");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        // TODO add your handling code here:
         ...
         try{
            ...
            Connection con;
            con= DriverManager.getConnection("jdbc:sqlserver://localhost:1433;databaseName=BASEMARCO; user=sa; password=sasa;");
    ...
    try{
            if (
                ...
                con= DriverManager.getConnection("jdbc:sqlserver://localhost:1433;databaseName=BASEMARCO; user=sa; password=sasa;");
                Statement stmt=con.createStatement();
                ResultSet rs=stmt.executeQuery("EXEC ACTALCALDIA '"+ var1+"','"+ var2 + "'");
    ...
    try{
            if (
                ...
                con= DriverManager.getConnection("jdbc:sqlserver://localhost:1433;databaseName=BASEMARCO; user=sa; password=sasa;");
                Statement stmt=con.createStatement();
                ResultSet rs=stmt.executeQuery("EXEC ELIMALCALDIA '"+op+"'");
    ...
    try{
            if (
                ...
                con= DriverManager.getConnection("jdbc:sqlserver://localhost:1433;databaseName=BASEMARCO; user=sa; password=sasa;");
                Statement stmt=con.createStatement();
                ResultSet rs=stmt.executeQuery("EXEC INGALCALDIA 'X"+ "','"+ var2 + "'");
    ...
    if (op.equals("- - - - - - - - - - - - - - - ")){
            ...
            con= DriverManager.getConnection("jdbc:sqlserver://localhost:1433;databaseName=BASEMARCO; user=sa; password=sasa;");
            Statement stmt=con.createStatement();
            ResultSet rs=stmt.executeQuery("EXEC BSALCALDIA '" +jTextField1.getText()+"'");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ALCALDIA.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
