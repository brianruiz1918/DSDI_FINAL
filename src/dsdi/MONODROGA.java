...
public class MONODROGA extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel3.setText("NOMBRE DE MONODROGA");
        jPanel1.add(jLabel3);
        jLabel3.setBounds(500, 130, 230, 30);

        jLabel2.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        jLabel2.setText("CLAVE DE MONODROGA");
        jPanel1.add(jLabel2);
        jLabel2.setBounds(80, 130, 220, 30);
        jPanel1.add(t2);
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/FOTOS/MONODROGAF.png"))); // NOI18N
        jPanel1.add(jLabel1);
    ...
    try{
            if (
                ...
                con= DriverManager.getConnection("jdbc:sqlserver://localhost:1433;databaseName=BASEYAIR; user=sa; password=sasa;");
                Statement stmt=con.createStatement();
                ResultSet rs=stmt.executeQuery("EXEC ACTMONODROGA '"+ var1+"','"+ var2 + "'");
    ...
    try{
            if (
                ...
                con= DriverManager.getConnection("jdbc:sqlserver://localhost:1433;databaseName=BASEYAIR; user=sa; password=sasa;");
                Statement stmt=con.createStatement();
                ResultSet rs=stmt.executeQuery("EXEC ELIMMONODROGA '"+op+"'");
    ...
    try{
            if (
                ...
                con= DriverManager.getConnection("jdbc:sqlserver://localhost:1433;databaseName=BASEYAIR; user=sa; password=sasa;");
                Statement stmt=con.createStatement();
                ResultSet rs=stmt.executeQuery("EXEC INGMONODROGA 'X"+ "','"+ var2 + "'");
    ...
    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
     ...
     try{
        ...
        if (op.equals("- - - - - - - - - - - - - - - ")){
                ...
                con= DriverManager.getConnection("jdbc:sqlserver://localhost:1433;databaseName=BASEYAIR; user=sa; password=sasa;");
                Statement stmt=con.createStatement();
                ResultSet rs=stmt.executeQuery("EXEC BSMONODROGA '" +jTextField1.getText()+"'");
