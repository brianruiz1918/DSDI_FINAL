...
public class ACCIONTERAP extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel3.setText("NOMBRE DE ACCION TERAPEUTICA");
        jPanel1.add(jLabel3);
        jLabel3.setBounds(500, 130, 330, 30);

        jLabel2.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        jLabel2.setText("CLAVE DE ACCIONTERAP");
        jPanel1.add(jLabel2);
        jLabel2.setBounds(80, 130, 270, 30);
        jPanel1.add(t2);
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/FOTOS/ACCIONTERAPF.png"))); // NOI18N
        jPanel1.add(jLabel1);
    ...
    try{
            if (
                ...
                con= DriverManager.getConnection("jdbc:sqlserver://localhost:1433;databaseName=BASEMARCO; user=sa; password=sasa;");
                Statement stmt=con.createStatement();
                ResultSet rs=stmt.executeQuery("EXEC ACTACCIONTERAP '"+ var1+"','"+ var2 + "'");
    ...
    try{
            if (
                ...
                con= DriverManager.getConnection("jdbc:sqlserver://localhost:1433;databaseName=BASEMARCO; user=sa; password=sasa;");
                Statement stmt=con.createStatement();
                ResultSet rs=stmt.executeQuery("EXEC ELIMACCIONTERAP '"+op+"'");
    ...
    try{
            if (
                ...
                con= DriverManager.getConnection("jdbc:sqlserver://localhost:1433;databaseName=BASEMARCO; user=sa; password=sasa;");
                Statement stmt=con.createStatement();
                ResultSet rs=stmt.executeQuery("EXEC INGACCIONTERAP 'X"+ "','"+ var2 + "'");
    ...
    try{
        ...
        if (op.equals("- - - - - - - - - - - - - - - ")){
                ...
                con= DriverManager.getConnection("jdbc:sqlserver://localhost:1433;databaseName=BASEMARCO; user=sa; password=sasa;");
                Statement stmt=con.createStatement();
                ResultSet rs=stmt.executeQuery("EXEC BSACCIONTERAP '" +jTextField1.getText()+"'");

                tabla.addColumn("ID ACCIONTERAP");
                tabla.addColumn("NOMBRE ACCT");
            ...
            if (fs==.1){
                ...
                if (bandera==1){
                 ...
                 JOptionPane.showMessageDialog(null,
                         "ID ACCIONTERAP: "+clave+
                         "\nNOMBRE DE ACCION TERAP: "+var2);
                }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ACCIONTERAP.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ACCIONTERAP().setVisible(true);
            }
        });
    }
