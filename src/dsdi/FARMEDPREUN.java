...
public class FARMEDPREUN extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jToggleButton1.setBounds(1050, 120, 50, 50);
        ...
        jPanel1.add(jLabel3);
        jLabel3.setBounds(900, 190, 120, 30);

        jLabel2.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        jLabel2.setText("FOLIO");
        jPanel1.add(jLabel2);
        jLabel2.setBounds(660, 120, 220, 30);

        jLabel4.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        jLabel4.setText("PRECIO");
        jPanel1.add(jLabel4);
        jLabel4.setBounds(660, 190, 230, 30);
        jPanel1.add(tf7);
        tf7.setBounds(900, 220, 210, 30);
        jPanel1.add(tf6);
        tf6.setBounds(660, 220, 190, 30);
        jPanel1.add(tf5);
        tf5.setBounds(660, 150, 210, 30);
        ...
        jScrollPane1.setBounds(20, 260, 1110, 310);
        jPanel1.add(tf1);
        tf1.setBounds(30, 150, 180, 30);
        ...
        jButton14.setBounds(270, 140, 40, 40);
        ...
        jButton15.setBounds(220, 140, 40, 40);

        jLabel5.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        jLabel5.setText("ID FARMACIA 2");
        jPanel1.add(jLabel5);
        jLabel5.setBounds(30, 120, 230, 30);
        jPanel1.add(tf2);
        tf2.setBounds(30, 220, 180, 30);

        jLabel6.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        jLabel6.setText("ID MEDICAMENTO 1");
        jPanel1.add(jLabel6);
        jLabel6.setBounds(30, 190, 230, 30);
        ...
        jButton16.setBounds(220, 210, 40, 40);
        ...
        jButton17.setBounds(270, 210, 40, 40);
        jPanel1.add(tf3);
        tf3.setBounds(340, 150, 180, 30);
        ...
        jButton18.setBounds(580, 140, 40, 40);
        ...
        jButton19.setBounds(530, 140, 40, 40);

        jLabel7.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        jLabel7.setText("ID PRESENTACION 1");
        jPanel1.add(jLabel7);
        jLabel7.setBounds(340, 120, 230, 30);
        jPanel1.add(tf4);
        tf4.setBounds(340, 220, 180, 30);

        jLabel8.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        jLabel8.setText("ID UNIDADMEDIDA 1");
        jPanel1.add(jLabel8);
        jLabel8.setBounds(340, 190, 230, 30);
        ...
        jButton20.setBounds(530, 210, 40, 40);
        ...
        jButton21.setBounds(580, 210, 40, 40);

        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/FOTOS/FARMEDPREUNF.png"))); // NOI18N
        jPanel1.add(jLabel1);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        bandera=1;
         try{
            ...
            Connection con;
            con= DriverManager.getConnection("jdbc:sqlserver://localhost:1433;databaseName=BASEYAIR; user=sa; password=sasa;");
            Statement stmt=con.createStatement();
            ResultSet rs=stmt.executeQuery("EXEC CONSFARMEDPREUN");
            
            tabla.addColumn("ID FARMACIA 2");
            tabla.addColumn("ID MEDICAMENTO 1");
            tabla.addColumn("ID PRESENTACION 1");
            tabla.addColumn("ID UNIDAD MEDIDA 1");
    ...
    try{
            if (
                ...
                con= DriverManager.getConnection("jdbc:sqlserver://localhost:1433;databaseName=BASEYAIR; user=sa; password=sasa;");
                Statement stmt=con.createStatement();
                ResultSet rs=stmt.executeQuery("EXEC ACTFARMEDPREUN '"+ var5 + "','"+ var1 + "','" +var2+"','"+var3+"','"+var4+"','"+var6+"','"+var7+"'" );
    ...
    try{
            if (
                ...
                con= DriverManager.getConnection("jdbc:sqlserver://localhost:1433;databaseName=BASEYAIR; user=sa; password=sasa;");
                Statement stmt=con.createStatement();
                ResultSet rs=stmt.executeQuery("EXEC ELIMFARMEDPREUN '"+ var1 + "','"+ var2 + "','" +var3+"','"+var4+"'"+",'"+var5+"'");
    ...
    try{
            if (
                ...
                con= DriverManager.getConnection("jdbc:sqlserver://localhost:1433;databaseName=BASEYAIR; user=sa; password=sasa;");
                Statement stmt=con.createStatement();
                ResultSet rs=stmt.executeQuery("EXEC INGFARMEDPREUN '"+ var1 + "','"+ var2 + "','" +var3+"','"+var4+"','"+var5+"',"+var6+","+var7+"" );
    ...
    try{
        ...
        op=c4.getSelectedItem().toString();
            if (op.equals("- - - - - - - - - - - - - - - ")){
                ...
                con= DriverManager.getConnection("jdbc:sqlserver://localhost:1433;databaseName=BASEYAIR; user=sa; password=sasa;");
                Statement stmt=con.createStatement();
                ResultSet rs=stmt.executeQuery("EXEC BSFARMEDPREUN '"+jTextField1.getText()+"'");
    ...
    private void jTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MouseClicked
        ...
        try {
            ...
            if (fs==.1){
                ...
                String clave, var2, var3, var4, var5, var6, var7;
                clave=(String)tabla.getValueAt(fs, 0);
                var2=(String)tabla.getValueAt(fs, 1);
                var3=(String)tabla.getValueAt(fs, 2);
                var4=(String)tabla.getValueAt(fs, 3);
                var5=(String)tabla.getValueAt(fs, 4);
                var6=(String)tabla.getValueAt(fs, 5);
                var7=(String)tabla.getValueAt(fs, 6);
    ...
    private void jButton16ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton16ActionPerformed
        ...
        bandera=2;
         try{
            ...
            con= DriverManager.getConnection("jdbc:sqlserver://localhost:1433;databaseName=BASEYAIR; user=sa; password=sasa;");
            Statement stmt=con.createStatement();
            ResultSet rs=stmt.executeQuery("EXEC CONSMEDICAMENTO");
            
            tabla.addColumn("ID MEDICAMENTO");
            tabla.addColumn("NOMBRE MEDICAMENTO");
            tabla.addColumn("ID LABORATORIO 1");
    ...
    private void jButton19ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton19ActionPerformed
        ...
        bandera=3;
         try{
            ...
            con= DriverManager.getConnection("jdbc:sqlserver://localhost:1433;databaseName=BASEYAIR; user=sa; password=sasa;");
            Statement stmt=con.createStatement();
            ResultSet rs=stmt.executeQuery("EXEC CONSPRESENTACION");
            
            tabla.addColumn("ID PRESENTACION");
    ...
    private void jButton20ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton20ActionPerformed
        ...
        bandera=4;
         try{
            ...
            con= DriverManager.getConnection("jdbc:sqlserver://localhost:1433;databaseName=BASEYAIR; user=sa; password=sasa;");
            Statement stmt=con.createStatement();
            ResultSet rs=stmt.executeQuery("EXEC CONSUNIDADMEDIDA");
            
            tabla.addColumn("ID UNIDAD DE MEDIDA");
            tabla.addColumn("CANTIDAD UNIDAD DE MEDIDA");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FARMEDPREUN.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FARMEDPREUN().setVisible(true);
            }
        });
    }
