...
public class MEDMONO extends javax.swing.JFrame {
    ...
    public MEDMONO() {
        ...
        c4.addItem("MATRICULA MONODROGA");
        c4.addItem("1.------------------------------------------------------------");
    ...
    private void initComponents() {
        ...
        jLabel3.setText("ID MONODROGA 1 ");
        jPanel1.add(jLabel3);
        jLabel3.setBounds(580, 130, 240, 30);

        jLabel2.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        jLabel2.setText("ID MEDICAMENTO2");
        jPanel1.add(jLabel2);
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/FOTOS/MEDMONOF.png"))); // NOI18N
        jPanel1.add(jLabel1);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        bandera=1;
         ...
         try{
            ...
            ResultSet rs=stmt.executeQuery("EXEC CONSMEDMONO");
            
            tabla.addColumn("ID MEDICAMENTO 2");
            tabla.addColumn("ID MONODROGA 1");
    ...
    try{
            if (
                ...
                con= DriverManager.getConnection("jdbc:sqlserver://localhost:1433;databaseName=BASEYAIR; user=sa; password=sasa;");
                Statement stmt=con.createStatement();
                ResultSet rs=stmt.executeQuery("exec ELIMMEDMONO '"+op+"'" + ",'"+op2+"'");
    ...
    try{
            if (
                ...
                con= DriverManager.getConnection("jdbc:sqlserver://localhost:1433;databaseName=BASEYAIR; user=sa; password=sasa;");
                Statement stmt=con.createStatement();
                ResultSet rs=stmt.executeQuery("EXEC INGMEDMONO '"+ var1 + "','"+ var2 + "'"  );
    ...
    try{
        ...
        op=c4.getSelectedItem().toString();
            ...
            ResultSet rs=stmt.executeQuery("EXEC BSMEDMONO '"+jTextField1.getText()+"'");
            ...
            if (op.equals("MATRICULA MONODROGA")) {
            DefaultTableModel tabla=new DefaultTableModel();
            Connection con;
            con= DriverManager.getConnection("jdbc:sqlserver://localhost:1433;databaseName=BASEYAIR; user=sa; password=sasa;");
            Statement stmt=con.createStatement();
            
            ResultSet rs=stmt.executeQuery("EXEC BSMEDMONO2 '"+jTextField1.getText()+"'");
    ...
    private void jButton16ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton16ActionPerformed
        ...
        bandera=3;
         try{
            ...
            con= DriverManager.getConnection("jdbc:sqlserver://localhost:1433;databaseName=BASEYAIR; user=sa; password=sasa;");
            Statement stmt=con.createStatement();
            ResultSet rs=stmt.executeQuery("EXEC CONSMONODROGA");
            
            tabla.addColumn("ID MONODROGA");
            tabla.addColumn("NOMBRE MONODROGA");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MEDMONO.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
