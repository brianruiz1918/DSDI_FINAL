...
public class UNIDADMEDIDA extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel3.setText("NOMBRE DE UNIDAD MEDIDA");
        jPanel1.add(jLabel3);
        jLabel3.setBounds(500, 130, 260, 30);

        jLabel2.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        jLabel2.setText("CLAVE DE UNIDAD MEDIDA");
        jPanel1.add(jLabel2);
        jLabel2.setBounds(80, 130, 240, 30);
        jPanel1.add(t2);
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/FOTOS/UNIDAD DE MEDIDA.png"))); // NOI18N
        jPanel1.add(jLabel1);
    ...
    try{
            if (
                ...
                con= DriverManager.getConnection("jdbc:sqlserver://localhost:1433;databaseName=BASEYAIR; user=sa; password=sasa;");
                Statement stmt=con.createStatement();
                ResultSet rs=stmt.executeQuery("EXEC ACTUNIDADMEDIDA '"+ var1+"','"+ var2 + "'");
    ...
    try{
            if (
                ...
                con= DriverManager.getConnection("jdbc:sqlserver://localhost:1433;databaseName=BASEYAIR; user=sa; password=sasa;");
                Statement stmt=con.createStatement();
                ResultSet rs=stmt.executeQuery("EXEC ELIMUNIDADMEDIDA '"+op+"'");
    ...
    try{
            if (
                ...
                con= DriverManager.getConnection("jdbc:sqlserver://localhost:1433;databaseName=BASEYAIR; user=sa; password=sasa;");
                Statement stmt=con.createStatement();
                ResultSet rs=stmt.executeQuery("EXEC INGUNIDADMEDIDA 'X"+ "','"+ var2 + "'");
    ...
    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
     ...
     try{
        ...
        if (op.equals("- - - - - - - - - - - - - - - ")){
                ...
                con= DriverManager.getConnection("jdbc:sqlserver://localhost:1433;databaseName=BASEYAIR; user=sa; password=sasa;");
                Statement stmt=con.createStatement();
                ResultSet rs=stmt.executeQuery("EXEC BSUNIDADMEDIDA '" +jTextField1.getText()+"'");

                tabla.addColumn("ID UNIDAD MEDIDA");
                tabla.addColumn("CANTIDAD UM");
            ...
            if (fs==.1){
                ...
                if (bandera==1){
                 ...
                 JOptionPane.showMessageDialog(null,
                         "ID UNIDAD DE MEDIDA: "+clave+
                         "\nNOMBRE DE UNIDAD DE MEDIDA: "+var2);
                }
