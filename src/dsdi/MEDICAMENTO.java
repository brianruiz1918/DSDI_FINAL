...
public class MEDICAMENTO extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jButton13.setBounds(890, 150, 40, 40);
        ...
        jButton12.setBounds(940, 150, 40, 40);
        ...
        jLabel3.setText("ID LABORATORIO1");
        jPanel1.add(jLabel3);
        jLabel3.setBounds(590, 120, 230, 30);

        jLabel2.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        jLabel2.setText("CLAVE DE MEDICAMENTO");
        jPanel1.add(jLabel2);
        jLabel2.setBounds(30, 120, 220, 30);

        jLabel4.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        jLabel4.setText("NOMBRE DE MEDICAMENTO");
        jPanel1.add(jLabel4);
        jLabel4.setBounds(290, 120, 230, 30);
        jPanel1.add(t3);
        t3.setBounds(590, 150, 260, 50);
        jPanel1.add(t2);
        t2.setBounds(290, 150, 260, 50);
        jPanel1.add(t1);
        t1.setBounds(30, 150, 210, 50);
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/FOTOS/MEDICAMENTOF.png"))); // NOI18N
        jPanel1.add(jLabel1);
    ...
    try{
            if (
                ...
                con= DriverManager.getConnection("jdbc:sqlserver://localhost:1433;databaseName=BASEYAIR; user=sa; password=sasa;");
                Statement stmt=con.createStatement();
                ResultSet rs=stmt.executeQuery("EXEC ACTMEDICAMENTO '"+ var1 + "','"+ var2 + "','"+ var3+"'" );
    ...
    try{
            if (
                ...
                con= DriverManager.getConnection("jdbc:sqlserver://localhost:1433;databaseName=BASEYAIR; user=sa; password=sasa;");
                Statement stmt=con.createStatement();
                ResultSet rs=stmt.executeQuery("EXEC ELIMMEDICAMENTO'"+op+"'");
    ...
    try{
            if (
                ...
                con= DriverManager.getConnection("jdbc:sqlserver://localhost:1433;databaseName=BASEYAIR; user=sa; password=sasa;");
                Statement stmt=con.createStatement();
                ResultSet rs=stmt.executeQuery("EXEC INGMEDICAMENTO '"+ var1 + "','"+ var2 + "','" +var3+"'");
    ...
    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
     ...
     try{
        ...
        if (op.equals("- - - - - - - - - - - - - - - ")){
                ...
                con= DriverManager.getConnection("jdbc:sqlserver://localhost:1433;databaseName=BASEYAIR; user=sa; password=sasa;");
                Statement stmt=con.createStatement();
                ResultSet rs=stmt.executeQuery("EXEC BSMEDICAMENTO '" +jTextField1.getText()+"'");
    ...
    private void jButton13ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton13ActionPerformed
        ...
        System.out.println("bandera:"+ban2);
         ...
         try{
            ...
            con= DriverManager.getConnection("jdbc:sqlserver://localhost:1433;databaseName=BASEYAIR; user=sa; password=sasa;");
            Statement stmt=con.createStatement();
            ResultSet rs=stmt.executeQuery("EXEC CONSLABORATORIO");
    ...
    private void jTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MouseClicked
        ...
        try {
            ...
            if (fs==.1){
                ...
                String clave, var2, var3, var4, varext1;
                ...
                System.out.println("Valor: "+ clave);
                 ...
                 JOptionPane.showMessageDialog(null,
                         "ID LABORATORIO: "+clave+
                         "\nNOMBRE DE LABORATORIO: "+var2);
                ...
                if (bandera==1){
                    ...
                    t3.setText(var3);
                 JOptionPane.showMessageDialog(null,
                         "ID MEDICAMENTO: "+clave+
                         "\nNOMBRE DE MEDICAMENTO: "+var2+
                         "\nID LABORATORIO: "+var3);
                }
            }
        }
