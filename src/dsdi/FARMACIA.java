...
public class FARMACIA extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jToggleButton1.setBounds(1030, 20, 50, 50);
        ...
        jPanel1.add(jLabel3);
        jLabel3.setBounds(530, 120, 230, 30);

        jLabel2.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        jLabel2.setText("CLAVE DE FARMACIA");
        jPanel1.add(jLabel2);
        jLabel2.setBounds(30, 120, 220, 30);

        jLabel4.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        jLabel4.setText("NOMBRE DE FARMACIA");
        jPanel1.add(jLabel4);
        jLabel4.setBounds(290, 120, 230, 30);
        jPanel1.add(t3);
        t3.setBounds(530, 150, 260, 50);
        jPanel1.add(t2);
        t2.setBounds(290, 150, 190, 50);
        jPanel1.add(t1);
        ...
        jButton14.setBounds(1070, 100, 40, 40);
        ...
        jButton15.setBounds(1020, 100, 40, 40);

        jLabel5.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        jLabel5.setText("ID FARMACEUTICO 1");
        jPanel1.add(jLabel5);
        jLabel5.setBounds(830, 120, 230, 30);

        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/FOTOS/FARMACIAF.png"))); // NOI18N
        jPanel1.add(jLabel1);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        System.out.println("ban:"+bandera);
         try{
    ...
    try{
            if (
                ...
                con= DriverManager.getConnection("jdbc:sqlserver://localhost:1433;databaseName=BASEYAIR; user=sa; password=sasa;");
                Statement stmt=con.createStatement();
                ResultSet rs=stmt.executeQuery("EXEC ACTFARMACIA '"+ var1 + "','"+ var2 + "','"+ var3+"','"+var4+"'" );
    ...
    try{
            if (
                ...
                con= DriverManager.getConnection("jdbc:sqlserver://localhost:1433;databaseName=BASEYAIR; user=sa; password=sasa;");
                Statement stmt=con.createStatement();
                ResultSet rs=stmt.executeQuery("EXEC ELIMFARMACIA '"+op+"'");
    ...
    try{
            if (
                ...
                con= DriverManager.getConnection("jdbc:sqlserver://localhost:1433;databaseName=BASEYAIR; user=sa; password=sasa;");
                Statement stmt=con.createStatement();
                ResultSet rs=stmt.executeQuery("EXEC INGFARMACIA '"+ var1 + "','"+ var2 + "','" +var3+"','"+var4+"'" );
    ...
    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
     ...
     try{
        ...
        if (op.equals("- - - - - - - - - - - - - - - ")){
                ...
                con= DriverManager.getConnection("jdbc:sqlserver://localhost:1433;databaseName=BASEYAIR; user=sa; password=sasa;");
                Statement stmt=con.createStatement();
                ResultSet rs=stmt.executeQuery("EXEC BSFARMACIA '" +jTextField1.getText()+"'");
    ...
    private void jTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MouseClicked
        ...
        try {
            ...
            if (fs==.1){
                ...
                String clave, var2, var3, var4, var4v;
                clave=(String)tabla.getValueAt(fs, 0);
                var2=(String)tabla.getValueAt(fs, 1);
                var3=(String)tabla.getValueAt(fs, 2);
                var4=(String)tabla.getValueAt(fs, 0);
                
                var4v=(String)tabla.getValueAt(fs, 3);
