...
public class MEDACC extends javax.swing.JFrame {
    ...
    public MEDACC() {
        ...
        c4.addItem("- - - - - - - - - - - - - - - ");    
        c4.addItem("MATRICULA MEDICAMENTO");
        c4.addItem("MATRICULA ACCIONTERAP");  
        c4.addItem("1.------------------------------------------------------------");
    ...
    private void initComponents() {
        ...
        jButton17.setBounds(960, 160, 40, 40);
        ...
        jButton16.setBounds(910, 160, 40, 40);
        ...
        jButton14.setBounds(450, 160, 40, 40);
        ...
        jButton15.setBounds(400, 160, 40, 40);
        ...
        jLabel3.setText("ID ACCION TERAPEUTICA 1 ");
        jPanel1.add(jLabel3);
        jLabel3.setBounds(580, 130, 240, 30);

        jLabel2.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        jLabel2.setText("ID MEDICAMENTO3");
        jPanel1.add(jLabel2);
        jLabel2.setBounds(80, 130, 210, 30);
        jPanel1.add(t2);
        t2.setBounds(580, 160, 320, 40);
        jPanel1.add(t1);
        t1.setBounds(80, 160, 310, 40);
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/FOTOS/MEDACCF.png"))); // NOI18N
        jPanel1.add(jLabel1);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        bandera=1;
         ...
         try{
            ...
            ResultSet rs=stmt.executeQuery("EXEC CONSMEDACC");
            
            tabla.addColumn("ID MEDICAMENTO 3");
            tabla.addColumn("ID ACCION TERAPEUTICA 1");
    ...
    try{
            if (
                ...
                con= DriverManager.getConnection("jdbc:sqlserver://localhost:1433;databaseName=BASEYAIR; user=sa; password=sasa;");
                Statement stmt=con.createStatement();
                ResultSet rs=stmt.executeQuery("exec ELIMMEDACC '"+op+"'" + ",'"+op2+"'");
    ...
    try{
            if (
                ...
                con= DriverManager.getConnection("jdbc:sqlserver://localhost:1433;databaseName=BASEYAIR; user=sa; password=sasa;");
                Statement stmt=con.createStatement();
                ResultSet rs=stmt.executeQuery("EXEC INGMEDACC '"+ var1 + "','"+ var2 + "'"  );
    ...
    try{
        ...
        op=c4.getSelectedItem().toString();
            ...
            if (op.equals("MATRICULA MEDICAMENTO")) {
            DefaultTableModel tabla=new DefaultTableModel();
            Connection con;
            con= DriverManager.getConnection("jdbc:sqlserver://localhost:1433;databaseName=BASEYAIR; user=sa; password=sasa;");
            Statement stmt=con.createStatement();
            
            ResultSet rs=stmt.executeQuery("EXEC BSMEDACC '"+jTextField1.getText()+"'");
            
                tabla.addColumn("ID MEDICAMENTO 3");
                tabla.addColumn("ID ACCION TERAP 1");
            ...
            if (op.equals("MATRICULA ACCIONTERAP")) {
            DefaultTableModel tabla=new DefaultTableModel();
            Connection con;
            con= DriverManager.getConnection("jdbc:sqlserver://localhost:1433;databaseName=BASEYAIR; user=sa; password=sasa;");
            Statement stmt=con.createStatement();
            
            ResultSet rs=stmt.executeQuery("EXEC BSMEDACC2 '"+jTextField1.getText()+"'");
    ...
    private void jButton16ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton16ActionPerformed
        bandera=3;
         try{
            ...
            con= DriverManager.getConnection("jdbc:sqlserver://localhost:1433;databaseName=BASEYAIR; user=sa; password=sasa;");
            Statement stmt=con.createStatement();
            ResultSet rs=stmt.executeQuery("EXEC CONSACCIONTERAP");
            
            tabla.addColumn("ID ACCT");
            tabla.addColumn("NOMBRE ACCION TERAP");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MEDACC.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
