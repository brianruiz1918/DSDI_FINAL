...
public class FARMTIPO extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel3.setText("ID TIPOTELF2 ");
        jPanel1.add(jLabel3);
        jLabel3.setBounds(400, 130, 240, 30);

        jLabel2.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        jLabel2.setText("ID FARMACIA1");
        jPanel1.add(jLabel2);
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/FOTOS/FARMTIPOF.png"))); // NOI18N
        jPanel1.add(jLabel1);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        bandera=1;
         try{
            ...
            tabla.addColumn("ID FARMACIA 1");
            tabla.addColumn("ID TIPOTELF 2");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FARMTIPO.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
